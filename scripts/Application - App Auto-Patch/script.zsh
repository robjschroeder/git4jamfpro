...
scriptLog="/var/log/xyz.techitout.log"						# Script Log Location [ /var/log/com.company.log ] (i.e., Your organization's default location for client-side logs)
...
supportTeamName="TechItOut"
supportTeamPhone="+1 (888) 867-5309"
supportTeamEmail="admin@techitout.xyz"
supportTeamWebsite="techitout.xyz"
